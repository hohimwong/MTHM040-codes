...
for j in 1:length(D_range)
    ...
    results = SJW_v5_LF(param, δq, δt, bdy, m, A0, B0, bdy_condi, a1=0.0,a2=0.0,fq=0.5,EqA_sat_coeff=0,EqB_sat_coeff=1) # adjust a1 a2 fq for the amplitude/frequency of time dep.
