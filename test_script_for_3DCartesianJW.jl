...
# the general form of the initial conditions below uses the IC from Kusano et al (2012), which is linear and force free
...
ThreeDimCartesianJW(param, δx, δy, δz, δt, x_bdy, y_bdy, z_bdy, i, A0, B0, C0, x_bdy_condi, y_bdy_condi, z_bdy_condi, iter_steps=60, line_step=150, vec_field="false")