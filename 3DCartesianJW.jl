...
function ThreeDimCartesianJW(param, δx, δy, δz, δt, x_bdy, y_bdy, z_bdy, i, A0, B0, C0, x_bdy_condi, y_bdy_condi, z_bdy_condi; iter_steps=20, line_step=30, vec_field="true", field_line="false", contour="true", b_eq=1e7)
