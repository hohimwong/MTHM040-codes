include("2D_JW_alpha2omega_real_u.jl")
# script to run the 2D_JW_alpha2omega_real_u code (ϵ=0)
...
results = TwoDJW_alp2ome_v3(param, δx, δy, δt, x_bdy, y_bdy, i, A0, B0, x_bdy_condi, y_bdy_condi, κ=1, τ=0, λ=1, ux=1, update=0,ϵ=0,tol=10e-3)
A_results = results[1]
B_results = results[2]
transient_steps = 0
